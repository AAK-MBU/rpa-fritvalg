...
def handle_process_dashboard(status: str, cpr: str, process_step_name: str, failure: Exception | None = None, rerun_config: dict | None = None, process_name: str = "Frit valg"):
    """
    ...
    if failure:
        step_run_update_data = process_step_run.build_step_run_update(status=status, failure=failure, rerun_config=rerun_config)
